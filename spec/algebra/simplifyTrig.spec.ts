...
describe('Trigonometric simplification regressions', () => {
	// Regression: https://github.com/jiggzson/nerdamer/issues/567
	it('reduces the Pythagorean identity minus one to zero', () => {
		expect(Expression.create('sin(x)^2+cos(x)^2-1').simplify().text()).toEqual('0');
	});
});
