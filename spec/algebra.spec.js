    ...
    it('should perform gcd and lcm operations correctly', function () {
        ...
        var testCases = [
            ...
            },
            {
                ...
                expected_gcd: 'x',
                expected_lcm: '(1375*x^9+1430*x^8+1872*x^6+37550*x^7+47075*x^5+7150*x^12+7510*x^3+9360*x+9360*x^10)*(361*x^7+473*x^5+5*x^11+72*x^3+90*x^9+91*x)'
            },
            {
