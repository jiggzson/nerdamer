 ...
 * @returns
 */
function toPiValue(x: Expression): Expression {
	let retval = x;
	if (PI.includes(x.value) && x.isLinear()) {
		retval = x.evaluate({ [x.value]: `${Rational.PI}` });
	}
 ...
 * ```
 */
export function cos(x: ExpressionInput): Expression {
 ...
 * ```
 */
export function sin(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function tan(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function sec(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function csc(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function cot(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function acos(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function asin(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function atan(x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function asec(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function acsc(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function acot(x: ExpressionInput) {
	x = Expression.create(x);
	let retval: Expression;
 ...
 * ```
 */
export function atan2(y: ExpressionInput, x: ExpressionInput): Expression {
	x = Expression.create(x);
 ...
 * ```
 */
export function cosh(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function sinh(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function tanh(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function sech(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function csch(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function coth(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function acosh(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function asinh(x: ExpressionInput) {
	x = Expression.create(x);
	// asinh(∞) = ∞, asinh(-∞) = -∞
	if (x.isPosInf() || x.isNegInf()) {
		return x.isNegInf() ? Expression.NegInf() : Expression.Inf();
 ...
 * ```
 */
export function atanh(x: ExpressionInput) {
	x = Expression.create(x);
	...
	if (x.isZero()) {
		...
		if (x.isComplex() || x.lt(minusOne()) || x.gt(one())) {
			//atanh(z) = (1/2) * ln((1 + z) / (1 - z))
 ...
 * ```
 */
export function asech(x: ExpressionInput) {
	x = Expression.create(x);
 ...
 * ```
 */
export function acsch(x: ExpressionInput) {
	x = Expression.create(x);
	// acsch(±∞) = 0
	if (x.isPosInf() || x.isNegInf()) {
		return zero();
 ...
 * ```
 */
export function acoth(x: ExpressionInput) {
	x = Expression.create(x);
	// acoth(±∞) = 0
	if (x.isPosInf() || x.isNegInf()) {
		return zero();
