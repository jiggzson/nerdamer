...
//        },
            ...
            do {
                ...
                if(iters >= jump_at) {
                    ...
                    if(norm > 1) {
                        ...
                        var n = (tries % Math.floor(halfway)) + 1;
         ...
         */
        quad: function (c, b, a) {
            var discriminant = _.subtract(_.pow(b.clone(), new Symbol(2)), _.multiply(_.multiply(a.clone(), c.clone()), new Symbol(4)))/*b^2 - 4ac*/;
            var det = _.pow(discriminant, new Symbol(0.5));
