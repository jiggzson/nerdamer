...
//                    __.integration.original = original_symbol.clone();
                ...
                try { 
                    ...
                    //e.g. 2*x
                        ...
                        retval = __.integration.poly_integrate(symbol, dx, depth || 0);
                    }
                    else if(g === EX) {
                        //check the base
                        ...
                        retval = new Symbol(0);
                        symbol.each(function(x) {
                            retval = _.add(retval, __.integrate(x, dx, depth || 0));
                        });
                    }
                    else if(g === CP) { 
                            ...
                            if(!a.contains(dx, true) && symbol.isLinear()) { //perform a deep search for safety
                                ...
                                if(fname === ABS) {
                                    ...
                                    if(x.group === S && !x.power.lessThan(0)) {
                                        if(core.Utils.even(x.power)) {
                                            retval = __.integrate(arg, dx, depth || 0);
                                        }
                                        else {
                                            var integrated = __.integrate(x, dx, depth || 0);
                                ...
                                if(fname === COS || fname === SIN) {
                                    ...
                                    if(p < 0) {
                                        ...
                                        retval = __.integrate(symbol, dx, depth || 0);
                                    }
                                    else {
                                        var arg = symbol.args[0],
                                        ...
                                        retval = _.add(_.multiply(_.multiply(na, rd), t), _.multiply(q, __.integrate(_.parse(rd2), dx, depth || 0)));
                                    }
                                }
                                //tan(x)^n or cot(x)^n
                                    ...
                                    if(symbol.args[0].isLinear(dx)) {
                                        ...
                                        if(r.power.equals(0))
                                            r = _.parse(r);
                                        retval = _.subtract(w, __.integrate(r, dx, depth || 0));
                                    }   
                                }
                                //sec(x)^n or csc(x)^n
                                    ...
                                    if(r.power.equals(0))
                                        r = _.parse(r);
                                    retval = _.add(w, _.multiply(new Symbol(n2/n1), __.integrate(r, dx, depth || 0)));
                                }
                                else
                                    __.integration.stop();
                            }
                        ...
                        if(cfsymbol.group !== CB) { 
                            retval = __.integrate(cfsymbol, dx, depth || 0);
                        }
                        else { 
                            ...
                            if(l === 2) { 
                                    ...
                                    if(g1 === FN && g2 === FN) { 
                                            ...
                                            if(arg1.equals(arg2)) {
                                                if(fn1 === SIN && fn2 === COS) {
                                                    ...
                                                    if(fn1 === SIN && sym1.power.add(sym2.power).equals(0)) {
                                                        sym1.fname = TAN;
                                                        sym1.updateHash();
                                                        retval = __.integrate(sym1, dx, depth || 0);
                                                    }
                                                    else {
                                                    ...
                                                    retval = __.integrate(_.multiply(sym1, sym2), dx, depth || 0);
                                                }
                                        ...
                                        if(sym1.power.equals(-1/2)) { 
                                            ...
                                            if(isInt(p) && core.Utils.even(p) && x.power.equals(2)) {
                                                ...
                                                var integral = __.integrate(dummy, 'u', depth || 0);
                                            ...
                                            expanded.each(function(x) {
                                                if(x.group === PL) {
                                                    x.each(function(y) {
                                                        retval = _.add(retval, __.integrate(_.multiply(sym2.clone(), y), dx, depth || 0));
                                                    });
                                                }
                                                else 
                                                    retval = _.add(retval, __.integrate(_.multiply(sym2.clone(), x), dx, depth || 0));
                                            });
                                        }
                                            ...
                                            if(x.group !== PL && x.isLinear()) {
                                                ...
                                                retval = __.integration.partial_fraction(symbol, dx, depth || 0);
                                        }
                                        else { 
                                            retval = __.integration.partial_fraction(symbol, dx, depth || 0);
                                        }
                                        ...
                                        if(sym1.power.greaterThan(0) && sym2.power.greaterThan(0)) {
                                            ...
                                            sym1.each(function(x) {
                                               retval = _.add(retval, __.integrate(_.multiply(x, sym2.clone()), dx, depth || 0));
                                            });
                                        }
                                    }
                                    else if(g1 === CP) {
                                ...
                                if(first.group === CP) { //TODO {support higher powers of x in the future}
                                    ...
                                    first.each(function(x) {
                                        ...
                                        var intg = __.integrate(t, dx, depth || 0);
